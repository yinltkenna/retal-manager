...
namespace PropertyService.src.Infrastructure.Data.Migrations
{
    ...
    public partial class initdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_RoomId_StartDate_EndDate",
                table: "Reservations",
                columns: new[] { "RoomId", "StartDate", "EndDate" });

            migrationBuilder.CreateIndex(
                name: "IX_RoomFacilities_RoomId_Name",
                table: "RoomFacilities",
                columns: new[] { "RoomId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RoomHistories_RoomId_CheckInAt",
                table: "RoomHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomMaintenances_RoomId_Status",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomStatusLogs_RoomId_ChangedAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomTypeAmenities_RoomTypeId_AmenityId",
                table: "RoomTypeAmenities",
                columns: new[] { "RoomTypeId", "AmenityId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RoomTypes_BranchId_TypeName",
                table: "RoomTypes",
                columns: new[] { "BranchId", "TypeName" },
                unique: true);
        }
